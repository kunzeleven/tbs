...
# CSS untuk styling Apple-like dengan modifikasi UI
def load_css():
    st.markdown("""
    <style>
    ...
    /* Header styling - lebih sederhana */
    .main-header {
    ...
    /* Targeting specific Streamlit button styling */
    ...
    /* Admin link di bawah - simple hyperlink center */
    .admin-link {
        text-align: center;
        margin-top: 3rem;
        padding: 2rem 0;
    ...
    /* Additional styling for better navigation */
    .nav-container {
        margin-bottom: 1rem;
    }
    </style>
...
# Halaman Form Booking dengan UI yang dimodifikasi
def booking_form_page():
    # Top navigation buttons dengan styling baru
    col1, col2, col3 = st.columns([6, 2, 2])
    
    with col2:
        if st.button("Booking Room Meeting 19", key="nav_home", 
    ...
    with col3:
        if st.button("📋 Lihat Daftar Booking", key="nav_list",
                    help="Lihat semua booking"):
            st.session_state.page = "list"
            st.rerun()
    
    # Header utama tanpa icon gedung
    st.markdown('<div class="main-header"><h1>Meeting Room Booking System</h1></div>', 
                unsafe_allow_html=True)
    ...
    # Admin link di bawah - simple hyperlink center
    admin_clicked = st.button("", key="hidden_admin_trigger", help="Admin", type="secondary")
    
    # Menggunakan HTML untuk admin link yang lebih baik
    st.markdown("""
    <div class="admin-link">
        <span onclick="document.querySelector('[data-testid=baseButton-secondary]').click()" 
              style="color: #007AFF; text-decoration: none; font-size: 14px; opacity: 0.7; cursor: pointer; transition: opacity 0.2s ease;"
...
# Halaman List Booking dengan navigation yang dimodifikasi
def booking_list_page():
    ...
    with col3:
        if st.button("📋 Lihat Daftar Booking", key="nav_list_active",
                    help="Lihat semua booking", disabled=True):
            pass  # Current page
    
    st.markdown('<div class="main-header"><h1>📋 Daftar Booking Meeting Room</h1></div>', 
                unsafe_allow_html=True)
    ...
    # Admin link di bawah
    admin_clicked = st.button("", key="hidden_admin_trigger_list", help="Admin", type="secondary")
...
# Halaman Admin dengan navigation yang dimodifikasi
def admin_page():
    if not check_admin_auth():
        # Top navigation untuk admin login
        col1, col2, col3 = st.columns([6, 2, 2])
    ...
    # Top navigation buttons untuk admin yang sudah login
